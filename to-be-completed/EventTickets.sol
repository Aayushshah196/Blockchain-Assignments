...
contract EventTickets {
    ...
    */
    function buyTickets(uint _numTickets) public payable {
        ...
        require(msg.value >= _numTickets * TICKET_PRICE, "Insufficient funds to purchase the tickets");
        ...
        if (msg.value > _numTickets * TICKET_PRICE) {
            ...
            uint refundAmount = msg.value - _numTickets * TICKET_PRICE;
    ...
    */
    function getRefund(address payable _refundRequester) public payable {
        require(myEvent.buyers[_refundRequester] > 0, "No tickets purchased for refund");

        uint numTickets = myEvent.buyers[_refundRequester];
